    ...
    $.jstree.core.prototype = {
        ...
        init: function (el, options) {
            ...
            this._data.core.original_container_html
                ...
                .remove();
            this.element.html("<" + "ul class='jstree-container-ul jstree-children' role='group'><" + "li id='j" + this._id + "_loading' class='jstree-initial-node jstree-loading jstree-leaf jstree-last' role='tree-item'><div class='ns-loader-overlay-tree'>" + "<div class='loader ns-loader-image'>" + "<div class='bg'></div>" + "<div class='circle'></div>" + "<div class='circle'></div>" + "<div class='circle'></div>" + "<div class='circle'></div>" + "<div class='circle'></div>" + "</div>" + "</div></li></ul>");
