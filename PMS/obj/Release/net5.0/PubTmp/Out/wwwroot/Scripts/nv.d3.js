    ...
    */
    ...
    nv.models.axis = function () {
            ...
            selection.each(function (data) {
                ...
                switch (axis.orient()) {
                    ...
                    case 'bottom':
                        ...
                        axisLabel
                            .attr('text-anchor', 'middle')
                            .attr('y', xLabelMargin - xAxisMargin)
                            .attr('x', w / 2);
                        if (showMaxMin) {
        ...
        chart._options = Object.create({}, {
            ...
            xAxisMargin: { get: function () { return xAxisMargin; }, set: function (_) { xAxisMargin = _; } },
    ...
    nv.models.discreteBarChart = function () {
                ...
                if (showXAxis) {
                    ...
                    if (truncateLabels > 0) {
                        xTicks
                            .selectAll('text')
                            .text(function (d) {
                                if (d.length >= truncateLabels) {
                                    d = d.substr(0, truncateLabels) + "...";
                                } else {
                                    d = d;
                                }
        ...
        chart._options = Object.create({}, {
            ...
            staggerLabels: { get: function () { return staggerLabels; }, set: function (_) { staggerLabels = _; } },
            rotateLabels: { get: function () { return rotateLabels; }, set: function (_) { rotateLabels = _; } },
            truncateLabels: { get: function () { return truncateLabels; }, set: function (_) { truncateLabels = _; } },
