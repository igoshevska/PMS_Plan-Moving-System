...
.value('taOptions',  {
    ...
    classes: {
        ...
        toolbarButton: "btn btn-transparent",
...
.factory('taToolFunctions', ['$window','taTranslations', function($window, taTranslations) {
    return {
        imgOnSelectAction: function(event, $element, editorScope){
            ...
            var fullButton = angular.element('<button type="button" class="btn btn-transparent btn-sm btn-small" unselectable="on" tabindex="-1">100% </button>');
            ...
            var halfButton = angular.element('<button type="button" class="btn btn-transparent btn-sm btn-small" unselectable="on" tabindex="-1">50% </button>');
            ...
            var quartButton = angular.element('<button type="button" class="btn btn-transparent btn-sm btn-small" unselectable="on" tabindex="-1">25% </button>');
            ...
            var resetButton = angular.element('<button type="button" class="btn btn-transparent btn-sm btn-small" unselectable="on" tabindex="-1">Reset</button>');
            ...
            var floatLeft = angular.element('<button type="button" class="btn btn-transparent btn-sm btn-small" unselectable="on" tabindex="-1"><i class="fa fa-align-left"></i></button>');
            ...
            var floatRight = angular.element('<button type="button" class="btn btn-transparent btn-sm btn-small" unselectable="on" tabindex="-1"><i class="fa fa-align-right"></i></button>');
            ...
            var floatNone = angular.element('<button type="button" class="btn btn-transparent btn-sm btn-small" unselectable="on" tabindex="-1"><i class="fa fa-align-justify"></i></button>');
            ...
            var remove = angular.element('<button type="button" class="btn btn-transparent btn-sm btn-small" unselectable="on" tabindex="-1"><i class="fa fa-trash-o"></i></button>');
        ...
        aOnSelectAction: function(event, $element, editorScope){
            ...
            var reLinkButton = angular.element('<button type="button" class="btn btn-transparent btn-sm btn-small" tabindex="-1" unselectable="on" title="' + taTranslations.editLink.reLinkButton.tooltip + '"><i class="fa fa-edit icon-edit"></i></button>');
            ...
            var unLinkButton = angular.element('<button type="button" class="btn btn-transparent btn-sm btn-small" tabindex="-1" unselectable="on" title="' + taTranslations.editLink.unLinkButton.tooltip + '"><i class="fa fa-unlink icon-unlink"></i></button>');
            ...
            var targetToggle = angular.element('<button type="button" class="btn btn-transparent btn-sm btn-small" tabindex="-1" unselectable="on">' + taTranslations.editLink.targetToggle.buttontext + '</button>');
